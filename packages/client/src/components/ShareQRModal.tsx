    ...
    >
      ...
      >
        <button
          ...
          autoFocus
          aria-label="Close"
          className="absolute top-2 right-2 w-9 h-9 flex items-center justify-center rounded text-zinc-500 hover:text-white text-xl leading-none"
        >×</button>

        <div className="flex flex-col items-center gap-3">
          <div className="bg-white p-3 rounded">
            <QRCodeSVG value={url} size={224} level="M" className="max-w-full h-auto" />
          </div>
