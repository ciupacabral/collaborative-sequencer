...
export function DebugOverlay({ ctx }: Props) {
  ...
  return (
    <div className="fixed bottom-0 inset-x-0 w-auto sm:bottom-2 sm:right-2 sm:inset-x-auto sm:w-72 max-h-[40vh] overflow-y-auto p-2 bg-black/90 text-zinc-200 border border-zinc-700 rounded text-[11px] leading-tight font-mono z-40 space-y-1">
      <div>
